...
import { HighlightedText } from '../../../styles/Global.js';
import { convertSeconds } from '../../../utils/helpers.js';
...
const ResultOverview = ({ result }) => {
    ...
    return (
        <ResultOverviewStyle>
            <p>
                You attempted questions: <HighlightedText> {totalQuestionAttempted} </HighlightedText>/{' '}
